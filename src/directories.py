...
class directories( dict ):
    def __init__( self, data_dir, output_dir, sex_files, psf_model_dir, code_dir, stilts_dir):
        ...
        self.__dict__['output_dir'] = output_dir

    def write_dirs( self ):
        file_obj = open('directories.cat',"w")
        file_obj.write("DATA_DIR: %s \n" %self.data_dir)
        file_obj.write("OUTPUT_DIR: %s \n" %self.output_dir)
    ...
    def get_dirs( self ):
        ...
        self.__dict__['output_dir'] = directories['PATH'][1]
        self.__dict__['sex_files'] = directories['PATH'][2]
        self.__dict__['psf_model_dir'] = directories['PATH'][3]
        self.__dict__['code_dir'] = directories['PATH'][4]
        self.__dict__['stilts_dir'] = directories['PATH'][5]
